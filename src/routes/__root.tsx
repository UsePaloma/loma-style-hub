...
import { initializeSupabasePersistence } from "../lib/supabase-persistence";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "USE LOMA · Moda Feminina" },
      { name: "description", content: "Moda feminina elegante com compra individual ou compra em grupo com desconto." },
      { name: "author", content: "USE LOMA" },
      { property: "og:title", content: "USE LOMA · Moda Feminina" },
      { property: "og:description", content: "Moda feminina elegante com compra individual ou compra em grupo com desconto." },
...
function RootComponent() {
  ...
  useEffect(() => {
    initializeSupabasePersistence().finally(() => setPersistenceReady(true));
  }, []);

  if (!persistenceReady) return <div className="min-h-screen bg-background" />;
